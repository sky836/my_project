...
class Exp_GWNET(Exp_Basic):
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            test_loss, test_mae, test_mse, test_rmse, test_mape, test_mspe, test_preds, test_trues = self.vali(test_data, test_loader, criterion)
            ...
            for i in range(pred_len):
                ...
                save_trainlog(log_path, f'Evaluate model on test data for horizon {i}, Test MAE: {mae}, Test RMSE: {rmse}, Test MAPE: {mape}')
    ...
    def test(self, setting, test=0):
        ...
        if test:
            ...
            path = '/kaggle/input/gwnet-mutiheads-pemsbay/checkpoint.pth'
