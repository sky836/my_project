...
from layers.Masks import MaskGenerator
from layers.Embed import PositionalEncoding
# from layers.Transformer_EncDec import Transformer_Encoder
from step.step_arch.tsformer.transformer_layers import TransformerLayers
...
class TSFormer(nn.Module):
    ...
    def __init__(self, patch_size, in_channel, embed_dim, num_heads, mlp_ratio,
                 dropout, num_token, mask_ratio, encoder_depth, decoder_depth, mode="pre-train"):
        super().__init__()
