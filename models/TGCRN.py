...
from GCGRU import GCGRU, GRUCell, TimeEncode, time_encoding, Time2Vec
    ...
    def forward(self, _input, y):
        ...
        if self.args.time_embedding and self.args.constrative_time and self.training:
            ...
            if self.args.od_flag:
                ...
                _input = _input[..., :self.output_dim]
                x_time = _input[..., self.output_dim:]
                y_time = y[..., self.output_dim:]
        else:
            pass
