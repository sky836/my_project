...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='PEMS07/data.npz', help='data file')
    # 2. model path
    ...
    # data loader
    parser.add_argument('--data', type=str, required=False, default='PEMS07', help='dataset type')
    parser.add_argument('--num_nodes', type=int, required=False, default=883, help='the nodes of dataset')
