...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_Time_embed_dim', type=int, default=32, help='dimension of encoder time')
    parser.add_argument('--encoder_Target_embed_dim', type=int, default=24, help='dimension of encoder target')
    parser.add_argument('--decoder_Time_embed_dim', type=int, default=32, help='dimension of decoder time')
