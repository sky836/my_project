...
if __name__ == '__main__':
    ...
    # basic config
    parser.add_argument('--task_name', type=str, required=False, default='stTrans_mae',
                        help='task name, options:[forcast, STEP, timeLinear, GWNET, Pretrain, STAEformer, stTrans, stTrans_mae]')
    parser.add_argument('--is_training', type=int, required=False, default=1, help='status')
    parser.add_argument('--model', type=str, required=False, default='stTrans_mae',
    ...
    # data loader
    parser.add_argument('--data', type=str, required=False, default='Pretrain_Forecast', help='dataset type')
