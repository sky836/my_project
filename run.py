...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, required=False, default='NYCTaxi', help='dataset type, Pretrain_Forecast')
    ...
    parser.add_argument('--learning_rate', type=float, default=0.00035, help='optimizer learning rate')
