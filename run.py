...
if __name__ == '__main__':
    ...
    # data loader
    parser.add_argument('--data', type=str, required=False, default='PEMS04', help='dataset type')
    parser.add_argument('--num_nodes', type=int, required=False, default=307, help='the nodes of dataset')
